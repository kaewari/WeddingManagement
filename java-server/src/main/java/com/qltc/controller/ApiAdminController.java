...
public class ApiAdminController {
    ...
    public ResponseEntity<Object> addOrUpdateOrder(@RequestBody Map<String, String> order) {
        try {
            ...
            o.setEmployee(this.userService.getUserById(Integer.parseInt(order.get("employeeId"))));
    ...
    @CrossOrigin
    public ResponseEntity<Object> getStatsRevenue(@RequestBody Map<String, String> params) {
        try {
            List<Object[]> list = this.revenueService.getStatsRevenue(params);
            if (list == null || list.isEmpty()) {
                message.put("Msg", "Don't have any value");
                return new ResponseEntity<>(message.toString(), HttpStatus.OK);
            }
