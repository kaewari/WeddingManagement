...
INSERT INTO `employees` VALUES (1,1,'Hoang','Son','111111','Manager',1),(2,14,'Nguyen','Tien','111112','Manager',2),(3,15,'Huynh','Huy','111113','Manager',3);
...
DROP TABLE IF EXISTS `order_dishes_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `order_dishes_details` (
  `id` int NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `order_dishes_details` WRITE;
/*!40000 ALTER TABLE `order_dishes_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `order_dishes_details` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user_permission` VALUES (1,1,1),(2,1,2),(3,1,3),(4,1,4),(5,1,5),(6,1,6),(7,1,7);
...
-- Dump completed on 2023-08-17 21:57:07
